...
public class DTGeoserverServiceFactoryImpl implements DTGeoserverServiceFactory {
	...
	public WFSGetFeature createWFSGetFeature(String serverURL, String version, String typeName, EnWFSOutputFormat outputformat, int maxFeatures, String bbox,
		...
		return new WFSGetFeature(serverURL, version, typeName, outputformat, maxFeatures, bbox, format_options, featureID, sortBy, propertyName, srsName);
	};
	...
	public WMSGetMap createWMSGetMap(String serverURL, String version, EnWMSOutputFormat format, String layers, String tiled, String transparent,
		...
		return new WMSGetMap(serverURL, version, format, layers, tiled, transparent, bgcolor, crs, srs, bbox, width, height, styles, exceptions, time, sld, sld_body);
	};
